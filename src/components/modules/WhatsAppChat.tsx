        ...
        <div className="p-4 border-b border-border">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-2">
              <Button onClick={handleBatchUpdateProfileImages} variant="ghost" size="sm" disabled={isUpdatingProfileImages} className="text-primary hover:bg-primary/10" title="Atualizar todas as fotos de perfil">
                {isUpdatingProfileImages ? <div className="h-4 w-4 animate-spin rounded-full border-2 border-primary border-t-transparent" /> : <RefreshCw className="h-4 w-4" />}
              </Button>
                      ...
                      workspaceConnections.map((connection) => (
                        <div key={connection.id} className="flex items-center gap-3 p-2 hover:bg-muted rounded cursor-pointer">
                          ...
                          <div className="flex flex-col">
                            <span className="text-sm font-medium">{connection.instance_name}</span>
          ...
          <div className="relative">
            ...
            <Input placeholder="Buscar" value={searchTerm} onChange={e => setSearchTerm(e.target.value)} className="pl-10 pr-10" />
