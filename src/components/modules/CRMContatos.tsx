...
export function CRMContatos() {
  ...
  const filteredContacts = contacts.filter(contact => {
    ...
    const matchesTag = !tagFilter || tagFilter === "todas" ||
  ...
  const handleAddContact = () => {
    ...
    setCustomFields([{ name: "Nome da Loja", value: "" }]);
  };
  ...
  const handleEditContact = (contact: Contact) => {
    ...
    const existingFields = contact.extra_info && typeof contact.extra_info === 'object' && contact.extra_info !== null 
      ? Object.entries(contact.extra_info).map(([name, value]) => ({ name, value: value as string }))
      : [{ name: "Nome da Loja", value: "" }];
