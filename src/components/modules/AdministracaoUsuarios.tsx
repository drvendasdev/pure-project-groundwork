      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            ...
            <Input placeholder="Pesquisar por nome, email, perfil ou empresa..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)} className="pl-10 w-64 bg-white text-gray-900 border-gray-300 focus:bg-white" />
          </div>

          {/* Botão Gerenciar cargos */}
          <Button variant="outline" onClick={handleGerenciarCargos} className="border-primary text-primary hover:bg-primary/10">
            Gerenciar cargos
          </Button>

          {/* Botão Adicionar usuário */}
          <Button variant="default" onClick={() => setIsAddModalOpen(true)} className="gap-2 rounded-xl">
