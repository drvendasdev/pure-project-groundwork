    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button 
            variant="outline" 
            className="border-brand-yellow text-foreground hover:bg-brand-yellow hover:text-black"
            onClick={handleGerenciarCargos}
          >
            Gerenciar cargos
          </Button>
            ...
            {filteredUsers.map((user) => (
              <TableRow key={user.id} className="border-b border-border hover:bg-muted/50">
                ...
                <TableCell>
                  <Badge 
                    variant="secondary"
                    className="bg-brand-yellow text-black hover:bg-brand-yellow-hover rounded-full px-3 py-1"
                  >
                    Ativo
                  </Badge>
                </TableCell>
