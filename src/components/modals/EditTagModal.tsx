          ...
          <div className="space-y-6 py-4">
            ...
            <div className="relative">
              <input
                ...
                className="w-full h-12 pt-2 pb-2 pl-12 pr-12 border border-input text-sm ring-offset-background appearance-none rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 cursor-pointer"
                style={{ backgroundColor: 'white', color: 'black', borderColor: 'rgb(209, 213, 219)' }}
              />
