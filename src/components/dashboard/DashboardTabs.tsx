  ...
  return (
    <Tabs defaultValue="visao-geral" className="w-full">
      ...
      <TabsList className="grid w-full grid-cols-4 mb-6 bg-primary/10">
        ...
        <TabsTrigger value="novidades" className="text-sm bg-primary/20 text-foreground data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">
          <Newspaper className="w-4 h-4 mr-2" />
          Novidades
        </TabsTrigger>
        <TabsTrigger value="eventos" className="text-sm bg-primary/20 text-foreground data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">
