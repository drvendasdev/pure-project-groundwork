      ...
      <AuthProvider>
        <WorkspaceProvider>
          ...
          <Routes>
            ...
            <Route path="/workspace-usuarios/:workspaceId" element={<ProtectedRoute><RoleProtectedRoute allowedRoles={['master', 'admin']}><TezeusCRM /></RoleProtectedRoute></ProtectedRoute>} />
